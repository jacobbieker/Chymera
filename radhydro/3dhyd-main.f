...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     &           ISYM,MAXTRM)
         ...
         delr=r(2)-r(1)
         do j=3,jmax1
           acc1=-(phi(j,2,1)-phi(j-1,2,1))/delr
           acc2=-2.0*(p(j,2,1)-p(j-1,2,1))/(rho(j,2,1)+rho(j-1,2,1))
     &           /delr
           acc3=jn(j,2,1)**2/r(j)**3
           write(61,162) j,acc1,acc2,acc3,acc1+acc2+acc3
 162       format(i8,1p5e12.4)
         enddo
         do j=3,jmax1
         write(61,162) j,rho(j,2,1)**gamma/p(j,2,1),rho(j,2,1),p(j,2,1)
         enddo
         write(61,*) konst,gamma

            write(6,*) 'returned from setup'
...
ccc         gama=gamma
ccc         write(61,161) (j,rho(j,2,1)**gama/p(j,2,1),j=1,jmax1,10)
ccc         write(61,161) (j,p(j,2,1),j=1,jmax1,10)
ccc         write(61,161) (j,phi(j,2,1),j=1,jmax1,10)
ccc         write(61,161) (j,a(j,2,1),j=1,jmax1,10)
ccc         write(61,*) ' '
...
ccc         stop
 ...
 161        format(i5,1p1e12.4,i5,1p1e12.4)
...
c...Equatorial fourier mode information (M=1-LMAX/2)
            ...
            LMWR9 = LMAX/2      
            WRITE(18,103)ITSTEP,TIME,(((COEF(J,2,L,I),L=1,LMWR9 )
     &          ,I=1,2),J=2,JMAX)
 103        FORMAT('COEF AT STEP ',I8,' TIME',1PE13.4,/,(1P10E13.5))
            WRITE(18,124)(RHF(I),I=2,JMAX)
...
c61         gma=gamm1-1.0
c61         write(61,161) (jp,(gma)*eps(jp,2,1)/p(jp,2,1),jp=1,jmax1,10)
c61         stop
